    ...
    <aside className="Empty-Aside">
      <div className="Empty-Aside-Items">
        <div
          ...
          className={
            selectedItem === "Notes"
              ? "enabledItem Empty-Aside-Item"
              : "disabledItem Empty-Aside-Item"
          }
          disabled={selectedItem === "Notes"}
        >
          <svg
            width="20"
            height="16"
        ...
        >
          ...
          >
            <g id="Frame">
              <path
                id="Vector"
                d="M15.625 4V3H9.37502V4H4.16669V6H5.20835V19C5.20835 20.1 6.14585 21 7.29169 21H17.7084C18.8542 21 19.7917 20.1 19.7917 19V6H20.8334V4H15.625ZM17.7084 19H7.29169V6H17.7084V19Z"
                fill="#18181B"
              />
              <path
                id="Vector_2"
                d="M9.375 8H11.4583V17H9.375V8ZM13.5417 8H15.625V17H13.5417V8Z"
                fill="#18181B"
              />
            </g>
          </svg>
